...
| 2 | Immutable snapshot as loot persistence after the live key is deleted | `Microsoft.AppConfiguration/configurationStores/snapshots/write` + `snapshots/read` (data actions), or a read-write store key | **WORKS — lab-verified 2026-09-26** |
...
This proves that deleting/rotating live configuration does not evict snapshot-held copies.
