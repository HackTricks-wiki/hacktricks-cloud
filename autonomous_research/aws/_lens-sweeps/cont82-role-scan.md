...
- [ ] iot-managed-integrations CreateDestination (RoleArn); license-manager CreateToken (RoleArns); bcm-dashboards UpdateScheduledReport (report export role); arc-region-switch associatedAlarms/triggers crossAccountRole (covered on the new page).
