...
## Historical vulnerabilities (not current managed-service techniques)

| Vulnerability | Current status |
|---|---|
| Apigee `GatewayToHeaven` / CVE-2025-13292 | Google bulletin GCP-2026-010 says managed Apigee was fixed in `1-16-0-apigee-3` and requires no customer action. Retained in the post-exploitation page as a single historical/unpatched-Hybrid chain with the exact Hybrid remediation floor, rather than five misleading current techniques. |
