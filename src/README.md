...
_Logos y animación de HackTricks diseñados por_ [_@ppieranacho_](https://www.instagram.com/ppieranacho/)_._ <sup>[[1]](#references)</sup>

### Ejecutar HackTricks Cloud localmente

El flujo de trabajo siguiente sigue las operaciones documentadas por Git de `clone`, `checkout` y `pull`, así como las ramas de idioma publicadas y la configuración de contenedores del repositorio. <sup>[[2]](#references)[[3]](#references)[[8]](#references)[[9]](#references)[[10]](#references)</sup>
```bash
...
```
El comando del contenedor sigue la interfaz `run` documentada de Docker y utiliza el servidor de vista previa HTTP de mdBook; el repositorio asigna el puerto 3000 del contenedor al puerto local 3377. <sup>[[4]](#references)[[5]](#references)[[7]](#references)</sup>
...
docker compose up
```
El `docker-compose.yml` incluido sirve la rama actualmente seleccionada en [http://localhost:3377](http://localhost:3377) con live reload. <sup>[[2]](#references)[[6]](#references)[[7]](#references)</sup>

### **Metodología de Pentesting de CI/CD**

**En la HackTricks CI/CD Methodology encontrarás cómo hacer pentesting de la infraestructura relacionada con actividades de CI/CD.** Lee la siguiente página para una **introducción:** <sup>[[11]](#references)</sup>

[pentesting-ci-cd-methodology.md](pentesting-ci-cd/pentesting-ci-cd-methodology.md)

### Metodología de Pentesting de Cloud

**En la HackTricks Cloud Methodology encontrarás cómo hacer pentesting de entornos cloud.** Lee la siguiente página para una **introducción:** <sup>[[12]](#references)</sup>
...
- [7] [Referencia del comando serve de mdBook](https://rust-lang.github.io/mdBook/cli/serve.html)
