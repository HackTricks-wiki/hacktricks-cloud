...
_Hacktricks logos और motion को_ [_@ppieranacho_](https://www.instagram.com/ppieranacho/)_ ने डिज़ाइन किया है।_ <sup>[[1]](#references)</sup>

### HackTricks Cloud को स्थानीय रूप से चलाना

नीचे दिया गया workflow Git के documented `clone`, `checkout`, और `pull` operations तथा repository की प्रकाशित language branches और container setup का अनुसरण करता है। <sup>[[2]](#references)[[3]](#references)[[8]](#references)[[9]](#references)[[10]](#references)</sup>
```bash
...
```
कंटेनर कमांड Docker के documented `run` interface का अनुसरण करता है और mdBook के HTTP preview server का उपयोग करता है; repository container के port 3000 को local port 3377 पर map करता है। <sup>[[4]](#references)[[5]](#references)[[7]](#references)</sup>

आपकी local HackTricks Cloud copy एक मिनट बाद **[http://localhost:3377](http://localhost:3377)** पर **उपलब्ध होगी**। <sup>[[2]](#references)</sup>

वैकल्पिक रूप से, यदि आपके पास Docker Compose है, तो इसे repository root से चलाएँ: <sup>[[2]](#references)[[6]](#references)</sup>
```bash
docker compose up
```
बंडल किया गया `docker-compose.yml` आपके वर्तमान checked-out branch को live reload के साथ [http://localhost:3377](http://localhost:3377) पर serve करता है। <sup>[[2]](#references)[[6]](#references)[[7]](#references)</sup>

### **Pentesting CI/CD Methodology**

**HackTricks CI/CD Methodology में आपको CI/CD activities से संबंधित infrastructure को pentest करने का तरीका मिलेगा।** **introduction** के लिए निम्नलिखित पेज पढ़ें: <sup>[[11]](#references)</sup>

[pentesting-ci-cd-methodology.md](pentesting-ci-cd/pentesting-ci-cd-methodology.md)

### Pentesting Cloud Methodology

**HackTricks Cloud Methodology में आपको cloud environments को pentest करने का तरीका मिलेगा।** **introduction** के लिए निम्नलिखित पेज पढ़ें: <sup>[[12]](#references)</sup>
